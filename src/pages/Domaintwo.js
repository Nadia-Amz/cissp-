    ...
    return(
        <>
            ...
            <article className="article-review">
                ...
                <ul>
                    <li><a href="#concepts">Data Security Concepts</a>. </li>
                    <li><a href="#classify-assets">Classify Assets</a>.</li>
                    <li><a href="#data-lifecycle">Data Lifecycle</a>.</li>
                    <li><a href="#privacy">Privacy</a>.</li>
                    <li><a href="#data-retention">Data Retention</a>.</li>
                    <li><a href="#data-states">Data States</a>.</li>
                    <li><a href="#data-security-controls">Security Controls</a>.</li>
                    <li><a href="#asset-handling-requirements">Asset Handling Requirements</a>.</li>
                    <li><a href="#data-remanence">Data Remanence</a>.</li>
                </ul>
                    <h2 id="concepts">Data Security Concepts</h2>
                        ...
                        <p><strong>Data quality</strong> reflects the integrity and reliability of data. Quality control and assurance can ensure good data
                        quality. Improving data quality aims to reduce errors of commission (Mistakes, or inacurrate transcription) and errors of omission 
                        (Something that had been left out).</p>
                        <p><strong>Data documentation</strong> allows longevity and reuse of data. Through documentation, users can understand, content, 
                        context, and limits of data.It also facilitates the exchange of data and enables easier discovery and interoperability of data. 
                        Data documentation can be through metadata,readme files, file contents (file names, header area&#8230;)&#8230;</p>
                    <h3>Data organization</h3>
                        <p>There are 2 types of data:</p>
                <ul>
                    <li>
                        <span>Unstructured: It lacks any formal data model.</span>
                    </li>
                    <li>Structured: When data is organized (Example: In a relational database)
                    </li>
                </ul>
                ...
                <ul>
                    <li>APEC CBPR</li>
                    <li>Canada PIPEDA</li>
                    <li>US : There is no overarching privacy law in the US. Only laws that apply to specific sectors :<ul>
                ...
                <ul id="block-7f3e32cb-c63d-4578-bb85-08962a2ad9f8">
                    ...
                    <li><span>Supplementation : When additional security controls are needed.</span></li>
                </ul>
                        <p>It is important to document scoping and tailoring decisiong, and their justification.</p>
                        <p>There are 3 types of controls :</p>
                <ul>
                    <li><span>Technical : Using computer capabilities and automation to implement safeguards.</span></li>
                ...
                <ul>
                    ...
                    <li><span>De-identification</span></li>
                    <li>Obfuscation</li><li>Data Tokenization</li>
                    <li>Anonymization</li>
                </ul>
                ...
                <ul>
                    <li>NSA/CSS Policy Manual 9-12</li><li>NIST SP 800-88 &#8220;Guidelines for Media Sanitization&#8221;.</li>
                </ul>
