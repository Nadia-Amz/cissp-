...
<ul><li><a href="#concepts">Data Security Concepts</a>.</li><li><a href="#classify-assets">Classify Assets</a>.</li><li><a href="#data-lifecycle">Data Lifecycle</a>.</li><li><a href="#privacy">Privacy</a>.</li><li><a href="#data-retention">Data Retention</a>.</li><li><a href="#data-states">Data States</a>.</li><li><a href="#data-security-controls">Security Controls</a>.</li><li><a href="#asset-handling-requirements">Asset Handling Requirements</a>.</li><li><a href="#data-remanence">Data Remanence</a>.</li></ul>



<h2 id="concepts">Data Security Concepts</h2>
...
<h2 id="classify-assets">Classify Assets</h2>
...
<ul><li>APEC CBPR</li><li>Canada PIPEDA</li><li>US : There is no overarching privacy law in the US. Only laws that apply to specific sectors :<ul><li>Privacy Act : Applicable only to US federal government agencies.</li><li>GLBA : Gramm-Leach-Bliley Act (For financial institutions).</li><li>COPPA : Children&#8217;s Online Privacy Protection Act (For online services directed to children under 13 years of age).</li><li>FERPA : Family Educational Rights and Privacy Act (Protect the privacy of student education records).</li><li>HIPPA : Health Insurance Portability and Accountability Act (For protecting sensitive patient health information). </li></ul></li></ul>
...
<ul><li>Data Owner: They are the person who is accountable. Most often, they are from senior management. They can grant or deny access to data, and are responsible for its classification.</li><li>Data Steward : They are responsible for data content and context. Their main goal is data quality.  </li><li>Data Custodian : They maintain data, secure it and make sure its available for authorized users.</li><li>Data Subject : For personal data, they are the person to which this data relates. You can encounter this role, most often, in the context of privacy. (For example, they are the person that the PII identifies).</li><li>Data User : They are the person who is accessing the data as part of their day-to-day job.</li><li>Data Controller : A person or a business who determines how to process data. They are accountable for it.</li><li>Data Processor : They process data on behalf of a data controller (Example: Cloud service providers).</li></ul>
...
<h2 id="data-states">Data States</h2>
...
<ul><li>At rest : When data is stored (e.g. Databases, data warehouses, files in a hard drive&#8230;).</li><li>In motion : When data is in transmission through a network.</li><li>In use : When data is being accessed by a user or a service account. Generally, data in use is located in the Computer RAM, CPU cache or CPU registers).</li></ul>



<h2 id="data-security-controls">Security Controls</h2>
...
<h2 id="asset-handling-requirements">Asset Handling Requirements</h2>
...
<h2 id="data-remanence">Data Remanence</h2>
...
<ul><li>Clearing : Media is formatted or overwritten once. This is the least effective method, and you can still recover data if you rely on this technique alone.</li><li>Purging : Overwriting multiple time, degaussing (Only for magnetic media like HDD or tapes), crypto-shredding&#8230; By these techniques, you may never recover data.</li><li>Destruction : This is the most effective method, but Media would be entirely destroyed. Examples include incineration and disk shredding. However, drilling a hole in the media is not a good way to destroy it. Data can still be recovered.</li></ul>
...
<ul><li>NSA/CSS Policy Manual 9-12</li><li>NIST SP 800-88 &#8220;Guidelines for Media Sanitization&#8221;.</li></ul>
